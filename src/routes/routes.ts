...
rotas.get("/aulas/:data_aula", new ControllerAula().filter_data_aula) // x
rotas.get("/aulas/:fk_turma", new ControllerAula().filter_turma) // x
...
rotas.get("/cursos/:eixo", new ControllerCurso().filterEixo) // x
rotas.get("/cursos/:modalidade", new ControllerCurso().filterModalidade) // x
