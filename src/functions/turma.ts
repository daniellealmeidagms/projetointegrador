...
const holidays = [
  new Date("2023-12-25"), new Date("2024-01-01")
];
...
const endDate = calculateEndDate(startDate, schedule.length);

console.log("Cronograma de Aulas:", schedule);
console.log("Data de Término da Turma:", endDate.toISOString().slice(0, 10));
